...
$(document).ready(function(){
    ...
    if(window.location.href.indexOf('transactionreport') > 0)
    {
     ...
     if(window.location.href.indexOf('datatable_export') > 0)
    {
...
$("#password-reset").submit(function(e){
    ...
    if(email!="")
    {
        $.ajax({
            type: "POST",
            url:base_phpurl+"/password/email", 
            ...
            if(response.status){
                ...
                if(typeof response.errors != "undefined" && Object.keys(response.errors).length > 0)
                {
                    $.each(response.errors, function (indexInArray, valueOfElement) { 
                         ...
                         $("#merchant-login #"+indexInArray+"_ajax_error").html(valueOfElement[0]);
                    });
...
$("#resend-mobile-sms").click(function(e){
    ...
    $.ajax({
        type:"GET",
        url:base_phpurl+"/resend-mobile-otp",
        dataType:"json",
        success:function (response) {
            if(response.status)
            {
...
function visiblePasssword(elementName,iconelement){
 ...
 function showTab(n) {
  ...
  function fixStepIndicator(n) {
    ...
    $("body").on("change",".logo-inputfile",function(e){
        ...
        $.ajax({
            url:base_phpurl+'/merchant/business-logo/update',
            type: 'POST',
            data:data,
            processData:false,
            contentType:false,
    ...
    function removeMerchantLogo(id,imagename){
        $.ajax({
            type:"POST",
            url:base_phpurl+"/merchant/business-logo/remove",
    ...
    function activateAccount(){
        $.ajax({
            type: "GET",
            url:base_phpurl+"/merchant/document-submission/success",
            dataType: "json",
            success: function (response) {
                if(response.status){
    ...
    function gePopuptForm($form){
        ...
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/load-activate-forms/"+$form,
            dataType: "html",
            success: function (response) {
                if($form == "company"){
 ...
 $("#update-my-details").submit(function(e){
    ...
    var html = '';
     $.ajax({
         type:"POST",
         url:base_phpurl+"/merchant/update-mydetails",
         data:getJsonObject(formdata),
         dataType: "json",
         success: function (response) {
 ...
 $("body").on("click","#send-email-again",function(e){
    ...
    $.ajax({
        type:"GET",
        url:base_phpurl+"/merchant/resend-change-email",
        dataType: "json",
        success: function (response) {
            if(response.status)
            {
...
$("body").on("click","#send-mobilesms-again",function(e){
    ...
    $.ajax({
        type:"GET",
        url:base_phpurl+"/merchant/resend-change-mobile",
        dataType: "json",
        success: function (response) {
            if(response.status)
            {
...
function viewAllNotifications(){
    $.ajax({
        type:"GET",
        url:base_phpurl+"/merchant/view-all-notifications",
        dataType:"json",
        success: function(response){
...
function viewAllMessages(){
    $.ajax({
        type:"GET",
        url:base_phpurl+"/merchant/view-all-messages",
        dataType:"json",
        success: function(response){
            $("#new-notification-count").html("0");
...
$("#resend-message").click(function(e){
    e.preventDefault();
    $.ajax({
        url:base_phpurl+"/resend-message",
        type:"get",
        dataType:"json",
        success:function(response){
            if(response.status)
...
function formatAMPM() {
    ...
    $("#nav-clock").html("<span style='color:#d7943d'>Date:</span> "+day+"-"+month+"-"+year+" "+hours + ':' + minutes +':'+ seconds +' ' + ampm);
...
$("#is_reminders_enabled").change(function(e){
    ...
    $.ajax({
        url:base_phpurl+"/merchant/reminder/enable",
        type:"POST",
        data:getJsonObject(formdata),
        dataType:"json",
        success:function(response){
...
function getBalanceCheck(){
    ...
    $.ajax({
        type: "GET",
        url: "/merchant/payout/balance",
        dataType: "json",
        success: function(response) {
            console.log(response.balance);
            $("#get_balance_id").text("₹ "+ response.balance)
        }
    });
}

function settlement_view(date) {
    //console.log(recorid);
    //alert(date);
    $("#view-settlement-date").modal({show:true});
    var settlement_date = date;
    $.ajax({
        type: "GET",
        url: "/merchant/settlement/view_by_date/" + settlement_date,
        dataType: "html",
        success: function(response) {
            console.log(response);
            $("#paginate_settlement_view_date").html(response);
        }
    });
}
...
function optionItems(){
    invoiceItemOptions = [];
    $.ajax({
        url:base_phpurl+"/merchant/get-all-items",
        type:"GET",
        dataType:"json",
        success:function(response){
            var html='';
...
function optionCustomers(option=""){
    ...
    var customer_id = "";
    $.ajax({
        url:base_phpurl+"/merchant/get-all-customers",
        type:"GET",
        dataType:"json",
        success:function(response){
...
function changeAppMode(element)
{
    ...
    if(documents_upload == "Y"){
       $.ajax({
           type:"GET",
           url:base_phpurl+"/merchant/change-app-mode/"+modevalue,
           data:"data",
           dataType:"json",
           success: function (response) {
            if(!response.status){
...
{
    $.ajax({
        url:base_phpurl+'/merchant/disable-popup',
        type:"GET",
        dataType:"json",
        success:function(response){
            $("#call-app-activation-modal").modal("hide");
...
{
    $.ajax({
        url:base_phpurl+'/merchant/new-coupon-id',
        type:"GET",
        dataType:"json",
        success:function(response){
...
//Form functionality starts
    ...
    function loadCustomerAddress(customer_id,invoiceEditObject)
    {
        ...
        customerState = {};
        $.ajax({
            url:base_phpurl+"/merchant/get-customer-address/"+customer_id,
            type:"GET",
            dataType:"json",
            success:function(response){
                var html='';
    ...
    function getMerchantDocumentForm()
    {
        ...
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/documents/upload/"+bussinessType,
            dataType:"html",
            success: function (response) {
...
// Retrieve data starts
    ...
    function getDashboardData()
    {
        ...
        var transactionHTML = "";
        $.ajax({
            url:base_phpurl+"/merchant/dashboard",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"html",
            success:function(response){
    ...
    function getDashboardSummary()
    {
        ...
        var appendid = $("#dashboard-form-summary input[name='module']").val();
        var formdata = $("#dashboard-form-summary").serializeArray();
        var transactionHTML = "";
        $.ajax({
            url:base_phpurl+"/merchant/dashboard",
            type:"POST",
            ...
            success:function(response){
                 ...
                 $('#dash_summary_info').html(null);
                $('#dash_summary_info').html(response.summary_view);
                dashborad_summary_amchartgraph(response.data);
                dashborad_summary_graph(response.data);


              //  console.log(response.summary_view);
    ...
    function getDashboardPayout()
    {
        console.log('in');
        var appendid = $("#dashboard-form-payout input[name='module']").val();
        var formdata = $("#dashboard-form-payout").serializeArray();
        var transactionHTML = "";
        $.ajax({
            url:base_phpurl+"/merchant/payout_overview",
            type:"POST",
            data:getJsonObject(formdata),
            async: false,
            // dataType:"Json",
            success:function(response){
                console.log(response);
                $('#payout_total_amount').html("₹"+response.dash_payout_summery['totalAmount']);
                $('#payout_number_of_transaction').html(response.dash_payout_summery['numberofTransaction']);
                $('#payout_totalSuccessTransaction').html(response.dash_payout_summery['totalSuccessTransaction']);
                $('#payout_totalFailedTransaction').html(response.dash_payout_summery['totalFailedTransaction']);
                $('#payout_totalChargesAmount').html("₹"+response.dash_payout_summery['total_charges']);
                $('#payout_totalTaxAmount').html("₹"+response.dash_payout_summery['tax_charges']);
               dashborad_payout_amchartgraph(response.data);
    ...
    function getGstInvoicereport()
    {
        ...
        var transactionHTML = "";
        $.ajax({
            url:base_phpurl+"/merchant/gstinvoicereport",
            type:"POST",
            data:getJsonObject(formdata),
            async: false,
            // dataType:"Json",
    ...
    function getInvoiceDownload()
    {
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/invoice/get_download",
            dataType:"html",
            success: function (response) {
                $("#paginate_invoice_download").html(response);
            }
        });
    }
    ...
    function getAllPayments(perpage)
    {
        var formdata = $("#transaction-download-form").serializeArray();
        if(perpage == null){
            var perpage = 10;
        }
        //console.log(perpage);
        $.ajax({
            url:base_phpurl+"/merchant/payments/"+perpage,
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"html",
            success:function(response){
    ...
    //Retrieve All Payments javascript functionality ends
     ...
     {
         $.ajax({
             url:base_phpurl+"/merchant/refunds/"+perpage,
             type:"GET",
             dataType:"html",
             success:function(response){
     ...
     {
         $.ajax({
             url:base_phpurl+"/merchant/orders/"+perpage,
             type:"GET",
             dataType:"html",
             success:function(response){
     ...
     {
         $.ajax({
             url:base_phpurl+"/merchant/disputes/"+perpage,
             type:"GET",
             dataType:"html",
             success:function(response){
     ...
     {
         $.ajax({
             url:base_phpurl+"/merchant/all-invoices/"+perpage,
             type:"GET",
             dataType:"html",
             success:function(response){
    ...
    function getAllItems(perpage=10){
        $.ajax({
            url:base_phpurl+"/merchant/items/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllCustomers(perpage=10){
        $.ajax({
            url:base_phpurl+"/merchant/customers/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllPaylinks(perpage=10){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/paylinks/get/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllQuickLinks(perpage=10){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/quicklinks/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllsettlement(perpage=10)
    {
 
        var formdata = $("#settlement-download-form").serializeArray();
        $(".loader_custom").show();
        $.ajax({
            url:base_phpurl+"/merchant/settlementpage/"+perpage,
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"html",
            success:function(response){
                $("#paginate_settlement_page").html(response);
                $(".loader_custom").hide();
            },
            error:function(){},
            complete:function(){}
    ...
    function getCustomerAddress(customerid,formid)
    {
        customerAddress = [];
        $.ajax({
            url:base_phpurl+"/merchant/get-customer-info/"+customerid,
            type:"GET",
            dataType:"json",
            success:function(response){
    ...
    {
        $.ajax({
            url:base_phpurl+"/merchant/api/get-api",
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function viewApi(api_id)
    {
        ...
        {
            $.ajax({
                url:base_phpurl+"/merchant/api/details/"+api_id,
                type:"GET",
                dataType:"json",
                success:function(response){
    ...
    function getRemindersData()
    {
        ...
        $.ajax({
            url:base_phpurl+"/merchant/reminder/get",
            type:"GET",
            dataType:"json",
            success:function(response){
    ...
    function getWebhookData()
    {
        ...
        var createdDate = "";
        $.ajax({
            url:base_phpurl+"/merchant/webhook/get",
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.length > 0)
    ...
    function getSupportData(perpage=10)
    {
        var tablerow = ""
        $.ajax({
            url:base_phpurl+"/merchant/support/get/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getFeedbackData(perpage=10)
    {
        var tablerow = ""
        $.ajax({
            url:base_phpurl+"/merchant/feedback/get/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllProducts(perpage=10)
    {
        var tablerow = ""
        $.ajax({
            url:base_phpurl+"/merchant/product/get/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllPageDetails(perpage=10)
    {
        var tablerow = ""
        $.ajax({
            url:base_phpurl+"/payment-pages/get-all-pages/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    {
        $.ajax({
            url:base_phpurl+"/merchant/coupons/get/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllCouponProducts()
    {
        processData = [];
        $.ajax({
            url:base_phpurl+"/merchant/product/get/all",
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.status)
    ...
    function getCustomerCaseData(perpage=10)
    {
        var tablerow = ""
        $.ajax({
            url:base_phpurl+"/merchant/customer-case/get/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
    ...
    function getAllMessages()
    {
        ...
        var messageHTML = ""
        $.ajax({
            url:base_phpurl+"/merchant/messages",
            type:"GET",
            dataType:"json",
            success:function(response){
                $.each(response,function(index,object){
    ...
    function getAllMerchantNotifications(perpage=10){
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/merchant-notifications/"+perpage,
            dataType:"html",
            success:function(response) {
    ...
    function getAllMerchantMessages(perpage=10){
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/merchant-messages/"+perpage,
            dataType:"html",
            success:function(response) {
    ...
    function getCouponsTypesSubtypes(loadat="")
    {
        ...
        var coupon_type = [];
        $.ajax({
            url:base_phpurl+"/merchant/coupon/options",
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.length > 0)
    ...
    function getStateGSTCode(stateid){
        ...
        if(stateid!=""){
            $.ajax({
                type:"GET",
                url:base_phpurl+"/merchant/customer/state/get-gstcode/"+stateid,
                dataType: "json",
                success: function (response) {
                   if(response.status)
                   {
    ...
    function getAllMerchantEmployees(perpage=10){
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/employee/get/"+perpage,
            dataType: "html",
            success: function (response) {
     ...
     function getAllMerchantLoginActivity(perpage=10){
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/logactivities/get/"+perpage,
            dataType: "html",
            success: function (response) {
                $("#paginate_loginActivity").html(response);
                $('[data-toggle="popover"]').popover();
            }
        });
    }

    function getAllMerchantEmployeesTypes($id){
        if($id){

             $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/employee/type/"+$id,
            dataType: "html",
            success: function (response) {
                $("#paginate_employees").html(response);
                $('[data-toggle="popover"]').popover();
...
//Store data starts
    ...
    $("#itemadd").submit(function(event){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/item/new",
            type:"POST",
            data:formdata,
            dataType:"json",
            success:function(response){
    ...
    $("#bulk-items-form").submit(function(event){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/item/bulk/new",
            type:"POST",
    ...
    $("#paylinkadd").submit(function(event){
        ...
        if(paylinkid == "" && formvalidate)
        {
            ...
            $("div#divLoading").addClass('show');
            $.ajax({
                url:base_phpurl+"/merchant/paylink/new",
                type:"POST",
                data:getJsonObject(formdata),
                dataType:"json",
                success:function(response){
    ...
    $("#bulk-paylink-form").submit(function(event){
        ...
        var data = new FormData(formdata);
        $.ajax({
            url:base_phpurl+"/merchant/paylink/bulk/new",
            type:"POST",
            enctype:"multipart/form-data",
            data:data,
            processData:false,
    ...
    $("#quick-link-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/quicklink/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#personal-info-form").submit(function(event){
       ...
       {
           $.ajax({
               url:base_phpurl+"/merchant/personal-info/save",
               type:"POST",
               data:getJsonObject(formdata),
               dataType:"json",
               success:function(response){
    ...
    function addInvoice(value='')
    {
        ...
        if(isformvalid)
        {
            ...
            {   
                $.ajax({
                    url:base_phpurl+"/merchant/invoice/add",
                    type:"POST",
                    data:formdata,
                    dataType:"json",
                    success:function(response){
    ...
    $("#add-customer-form").submit(function(event){
        ...
        {
            $.ajax({
                url:base_phpurl+"/merchant/customer/add",
                type:"POST",
                data:getJsonObject(formdata),
                dataType:"json",
                success:function(response){
    ...
    $("#add-customer-address-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/customer-address/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#generate-api").click(function(e){
        e.preventDefault();
        $.ajax({
            url:base_phpurl+"/merchant/api/add",
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.length > 0)
    ...
    $("#webhook-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/webhook/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    //Store payout webhook functionality starts here
    $("#payout-webhook-form").submit(function(e){
        e.preventDefault();
        var formdata = $("#payout-webhook-form").serializeArray();
        $.ajax({
            url:base_phpurl+"/merchant/payoutwebhook/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
                if(response.status)
                {
                    $("#ajax-payout-webhook-response").html(response.message).css({"color":"green"});
                }
            },
            error:function(){},
            complete:function(){
                getPayoutWebhookData();
                setTimeout(() => {
                    $("#ajax-payout-webhook-response").html("")
                }, 1500);
            }
        })
    });
    //Store payout webhook functionality ends here
    function editipwhitelist(id){
        $.ajax({
            url:base_phpurl+"/merchant/get_ip_whitelist/"+id,
            type:"get",
            dataType:"json",
            success:function(response){
                console.log(response);
                $("#ipeditModal").modal({show:true,backdrop:'static',keyboard:false});
                $("#editipaddress").val(response.ipwhitelist);
    ...
    $("#expiry-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/reminder/add",
            type:"POST",
            data:formdata,
            dataType:"json",
            success:function(response){
    ...
    $("#support-form").submit(function(e){
        ...
        var data = new FormData(formdata);
        $.ajax({
            url:base_phpurl+"/merchant/support/add",
            type:"POST",
            data:data,
            processData:false,
            contentType:false,
    ...
    $("#feedback-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/feedback/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#add-product-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/product/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#merchant-comment-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/comment/add",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#coupon-new-edit-form").submit(function(e){
        ...
        if(formsubmit)
        {
            ...
            $.ajax({
                url:base_phpurl+"/merchant/coupon/add",
                type:"POST",
                data:getJsonObject(formdata),
                dataType:"json",
                success:function(response){
    ...
    //Payout reseller code starts here
    $("#reseller-payout-statement-form").submit(function(e){
        e.preventDefault();
        var formdata = $(this).serializeArray();
        $(".loader_custom").show();
        $.ajax({
            type: "POST",
            url: base_phpurl+"/merchant/payout/reseller/getStatement",
            data: getJsonObject(formdata),
            dataType: "html",
            success: function(response) {
                
                $("#paginate_resellerpayoutstatement").html(response);
                $(".loader_custom").hide();
            },
    ...
    function payoutreselleredit(recorid) {
            var nonprecisonKeys = ["id", "merchant_id", "business_type_id"];
            $.ajax({
                type: "GET",
                url: "/merchant/payout/reseller/get-merchant-charge/" + recorid,
                dataType: "json",
                success: function(response) {
                    $("#payout-reseller-merchant-charges-modal").modal('show');
                    if (typeof response !== undefined && Object.keys(response).length > 0) {
                        
                        $.each(response, function (key, value) {
                            console.log(value);
                                $("#AMAZON_" + value.type).val(value.AMAZON);
                                $("#IMPS_" + value.type).val(value.IMPS);
                                $("#NEFT_" + value.type).val(value.NEFT);
                                $("#PAYTM_" + value.type).val(value.PAYTM);
                                $("#RTGS_" + value.type).val(value.RTGS);
                                $("#UPI_" + value.type).val(value.UPI);
                                $("#max_range_" + value.type).val(value.max_range);
                                $("#min_range_" + value.type).val(value.min_range);
                                $("#type_" + value.type).val(value.type);
                                $("#volume_count_" + value.type).val(value.volume_count);

                        });
                    } else {
                        $("#merchant_map_ajax_error").html(response.message).css({ "color": "red" });
                    }
                }
            });
        }

    $("#get_dash_payout_reseller_merchant").on("change", function(e) {
        //getDashboardPayoutResellerSummary();
        getDashboardPayoutResellerCount();
    });

    $("#get-payout-merchant-transaction-form").submit(function(e){

        $('#reseller_search_formdata').show();
        e.preventDefault();
        var formdata = $("#get-payout-merchant-transaction-form").serializeArray();
        //console.log(formdata[0].value);
        $("#download_payout_reseller_id").val(formdata[0].value);
        var perpage = 10;
        $('#reseller_merchant_download').val(formdata[0]['value']);
        $(".loader_custom").show();
        $.ajax({
            url: "/merchant/payout/reseller/get-merchant-transaction/" + perpage,
            type: "POST",
            data: getJsonObject(formdata),
            dataType: "html",
            success: function(response) {
                
                $("#paginate_getmerchantresellertransaction").html(response);
            },
            error: function() {},
            complete: function() {
                $(".loader_custom").hide();
                setTimeout(() => {
                    $("#map-ajax-response-message").html("");
                }, 3000);
            },
        })
    });
    function getPayoutResellerMechant(perpage=10){

        $.ajax({
            url:"/merchant/payout/reseller/merchant/"+perpage,
            type:"GET",
            dataType:"html",
            success:function(response){
                $("#paginate_payout_reseller_merchant").html(response);
            },
            error:function(error){
    ...
    function getDashboardPayoutResellerCount(){
        var formdata = $("#dashboard-payout-reseller-summary").serializeArray();
        var perpage=10;
        $(".loader_custom").show();
        $.ajax({
            url: "/merchant/payout/reseller/get-dash-reseller-transaction-count/" + perpage,
            type: "POST",
            data: getJsonObject(formdata),
            dataType: "html",
            success: function(response) {
                ...
                var get_total_amount = parsedResponse.get_total_amount;
                var total_charges = parsedResponse.total_charges;
                var total_tax = parsedResponse.total_tax;
                var success_ratio = parsedResponse.success_ratio;
                var no_of_success = parsedResponse.no_of_success;
                var payout_balance = parsedResponse.payout_balance;
                $("#total_volume").html("₹"+get_total_amount);
                $("#total_commission").html("₹"+total_charges);
                $("#total_tax").html("₹"+total_tax);
                $("#success_ratio").html(no_of_success+"|"+success_ratio+"%");
                $("#payout_reseller_balance").html("₹"+payout_balance);
            },
            error: function() {},
            complete: function() {
                setTimeout(() => {
    ...
    function getDashboardPayoutResellerSummary(){
        var formdata = $("#dashboard-payout-reseller-summary").serializeArray();
        var perpage=10;
        $(".loader_custom").show();
        $.ajax({
            url: "/merchant/payout/reseller/get-dash-reseller-transaction/" + perpage,
            type: "POST",
            data: getJsonObject(formdata),
            dataType: "html",
            success: function(response) {
                ...
                // var jsonData = response.substring(jsonStartIndex, jsonEndIndex + 1);
    
                // var parsedData = JSON.parse(response);
                // var totalcommissionAmount = parsedData.get_total_amt_total;
                // var get_gst_charge_total = parsedData.get_gst_charge_total;
                // var total_volume = parsedData.total_volume;
    
                
                // $("#total_volume").html("₹"+total_volume);
                // $("#total_commission").html("₹"+totalcommissionAmount);
                // $("#total_tax").html("₹"+get_gst_charge_total);
                
                $("#paginate_dash_reseller_merchant_transaction").html(response);
            },
            error: function() {},
            complete: function() {
                setTimeout(() => {
    ...
    //Payout reseller code ends here
    
    //reseller code starts here
$("#merchant-mapping-form").submit(function(e){
    e.preventDefault();
    var formdata = $("#merchant-mapping-form").serializeArray();
    $.ajax({
        url:"/merchant/reseller/merchat-mapping",
        type:"POST",
        data:getJsonObject(formdata),
        dataType:"json",
        success: function(response) {
            console.log(response);
            if (response.status) {
                $("#merchant-map-ajax-response-message").html(response.message).css({ "color": "green" });
                // $("#merchant-mapping-form")[0].reset();
            } else {
                if (Object.keys(response.errors).length > 0) {
                    $.each(response.errors, function(name, message) {
                        $("#" + name + "_ajax_error").html(message[0]).css({ "color": "red" });
                        $("#merchant-mapping-form select[name=" + name + "]").click(function() {
        ...
        complete: function() {
            setTimeout(() => {
                $("#merchant-map-ajax-response-message").html("");
            }, 5000);
        },
    })
});

function getResellerMechant(perpage=10){

    $.ajax({
        url:"/merchant/reseller/merchant/"+perpage,
        type:"GET",
        dataType:"html",
        success:function(response){
            $("#paginate_reseller_merchant").html(response);
        },
        error:function(error){
...
$("#reseller-transaction-download").click(function(e){
    e.preventDefault();
    var formdata = $("#get-merchant-transaction-form").serializeArray();
    $.ajax({
        url: "/merchant/reseller/merchant-transaction-download",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function(response) {
...
$("#get-merchant-transaction-form").submit(function(e){

    $('#reseller_search_formdata').show();
    e.preventDefault();
    var formdata = $("#get-merchant-transaction-form").serializeArray();
    //console.log(formdata[0].value);
    $("#download_reseller_id").val(formdata[0].value);
    var perpage = 10;
    $('#reseller_merchant_download').val(formdata[0]['value']);
    $(".loader_custom").show();
    $.ajax({
        url: "/merchant/reseller/get-merchant-transaction/" + perpage,
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function(response) {
...
function getResellerReport(){
    var formdata = $("#reseller-report").serializeArray();
    var perpage=10;
    $(".loader_custom").show();
    $.ajax({
        url: "/merchant/reseller/transaction-report/" + perpage,
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function(response) {
            
            $("#paginate_transaction_report").html(response);
        },
        error: function() {},
        complete: function() {
            setTimeout(() => {
...
function getDashboardResellerSummary(){
    var formdata = $("#dashboard-reseller-summary").serializeArray();
    var perpage=10;
    $(".loader_custom").show();
    $.ajax({
        url: "/merchant/reseller/get-dash-reseller-transaction/" + perpage,
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function(response) {
...
function getDashboardResellerCount(){
    var formdata = $("#dashboard-reseller-summary").serializeArray();
    var perpage=10;
    $(".loader_custom").show();
    $.ajax({
        url: "/merchant/reseller/get-dash-reseller-transaction-count/" + perpage,
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "html",
        success: function(response) {
            console.log(response);
            var parsedResponse = JSON.parse(response);
            var totalVolume = parsedResponse.total_volume;
            var totalcommissionAmount = parsedResponse.get_total_amt_total;
            var get_gst_charge_total = parsedResponse.get_gst_charge_total;
            var success_ratio = parsedResponse.success_ratio;
            var no_of_success = parsedResponse.no_of_success;
            $("#total_volume").html("₹"+totalVolume);
            $("#total_commission").html("₹"+totalcommissionAmount);
            $("#total_tax").html("₹"+get_gst_charge_total);
            $("#success_ratio").html(no_of_success+"|"+success_ratio+"%");
        },
...
$("#get_dash_reseller_merchant").on("change", function(e) {
    getDashboardResellerSummary();
    getDashboardResellerCount();
});

function getResellerPriceSetting() {
    //console.log(recorid);
        var nonprecisonKeys = ["id", "merchant_id", "business_type_id"];
        $.ajax({
            type: "GET",
            url: "/merchant/reseller/get-reseller-charge",
            dataType: "json",
            success: function(response) {
                console.log(response);
                if (typeof response.merchantcharge != undefined && Object.keys(response.merchantcharge).length > 0) {
                    $.each(response.merchantcharge[response.merchantcharge.length - 1], function(key, value) {
                        if (typeof value == "number" && $.inArray(key, nonprecisonKeys) == -1) {
      
                            $("#merchant-charges-form #" + key).val(value.toPrecision(3));
                            $("#merchant-charges-form #" + key).prop('disabled', true);
                        } else {
      
                            $("#merchant-charges-form #" + key).val(value);
                            $("#merchant-charges-form #" + key).prop('disabled', true);
                            $("#merchant-charges-form input[name=" + key + "][value=" + value + "]").prop('checked', true);
                            $("#merchant-charges-form input[name=" + key + "][value=" + value + "]").prop('disabled', true);
                        }
      
                    });
                    $("#merchant-charges-form input[type='submit']").val("Update Charges");
                    $("#merchant-charges-form input[type='submit']").prop('disabled', true);
                    $("#merchant-charges-modal").modal('show');//modal({ show: true, backdrop: "static", keyboard: false });
                }
                
                if(response.getBasicInfo){
                    $('#info_merchant_gid').val(response.getBasicInfo[0].merchant_gid);
                    $('#info_merchant_name').val(response.getBasicInfo[0].name);
                    $('#info_merchant_status').val(response.getBasicInfo[0].merchant_status);
                    $('#info_email').val(response.getBasicInfo[0].email);
                    $('#info_mobile_no').val(response.getBasicInfo[0].mobile_no);
...
function reselleredit(recorid) {
//console.log(recorid);
    var nonprecisonKeys = ["id", "merchant_id", "business_type_id"];
    $.ajax({
        type: "GET",
        url: "/merchant/reseller/get-merchant-charge/" + recorid,
        dataType: "json",
        success: function(response) {
            // console.log(response.getBasicInfo[0]);
            if (typeof response.merchantcharge != undefined && Object.keys(response.merchantcharge).length > 0) {
                $.each(response.merchantcharge[response.merchantcharge.length - 1], function(key, value) {
                    if (typeof value == "number" && $.inArray(key, nonprecisonKeys) == -1) {
...
$("#resellermodal").click(function(e) {
    e.preventDefault();
...
$("#merchant-charges-form").submit(function(e) {
    ...
    $.ajax({
        ...
        url:base_phpurl+"/merchant/reseller/add-merchant-charge",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function(response) {
...
function getMerchantBusinessType(element, formName) {
    ...
    if (merchant_id != "") {
        $.ajax({
            type: "GET",
            url: "/merchant/technical/get-merchant-business-type/" + merchant_id,
            dataType: "json",
            success: function(response) {
                if (typeof response != undefined && Object.keys(response).length > 0) {
  ...
  $("[data-target='#commission']").click(function(e){
    e.preventDefault();
    var formdata = $("#get-merchant-commission").serializeArray();
    $.ajax({
        url: "/merchant/reseller/get-reseller-commission-report",
        type: "POST",
        data: getJsonObject(formdata),
        dataType: "json",
        success: function(response) {
           // $('#commission-modal').show();
            (response['today'][0]['amount']!=null) ? $('#today_commission').html('₹ '+response['today'][0]['amount']) : $('#today_commission').html('₹ 0.00');
            (response['yesterday'][0]['amount']!=null) ? $('#yesterday_commission').html('₹ '+response['yesterday'][0]['amount']) : $('#yesterday_commission').html('₹ 0.00');
            (response['current_month'][0]['amount']!=null) ? $('#current_month_commission').html('₹ '+response['current_month'][0]['amount']) : $('#current_month_commission').html('₹ 0.00');
            (response['last_month'][0]['amount']!=null) ? $('#last_month_commission').html('₹ '+response['last_month'][0]['amount']) : $('#last_month_commission').html('₹ 0.00');
            (response['tax_current_month'][0]['amount']!=null) ? $('#current_month_tax_commission').html('₹ '+response['tax_current_month'][0]['amount']) : $('#current_month_tax_commission').html('₹ 0.00');
            (response['tax_last_month'][0]['amount']!=null) ? $('#last_month_tax_commission').html('₹ '+response['tax_last_month'][0]['amount']) : $('#last_month_tax_commission').html('₹ 0.00');           
        }
    });
});
//reseller code ends here
    ...
    $("#merchant-employee-form").submit(function(e){
        ...
        $.ajax({
            type:"POST",
            url:base_phpurl+"/merchant/employee/add",
            data:getJsonObject(formdata),
            dataType:"json",
            success: function (response) {
                if(response.status){
    ...
    $("#company-info-form").submit(function(e){
        ...
        $.ajax({
            type:"POST",
            url:base_phpurl+"/merchant/company-info/update",
            data:getJsonObject(formdata),
            dataType:"json",
            success: function (response) {
                if(response.status)
    ...
    $("#business-info-form").submit(function(e){
        ...
        $.ajax({
            type:"POST",
            url:base_phpurl+"/merchant/business-info/update",
            data:getJsonObject(formdata),
            dataType:"json",
            success: function (response) {
                if(response.status)
    ...
    $("#business-detail-info-form").submit(function(e){
        ...
        {   
            $.ajax({
                type:"POST",
                url:base_phpurl+"/merchant/business-details-info/save",
                data:getJsonObject(formdata),
                dataType:"json",
                success: function (response) {
                    if(response.status)
...
//Edit data starts
    ...
    function transactionDetails(trans_id)
    {
        ...
        $.ajax({
            url:base_phpurl+"/merchant/payment/get/"+trans_id,
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.length > 0)
    ...
    function transactionDetailsView(trans_id)
    {
        ...
        $.ajax({
            url:base_phpurl+"/merchant/transactionInfo?transactionID="+trans_id,
            type:"GET",
            // dataType:"json",
            success:function(response){
                //console.log(response);
                $("#detail-transaction-model").modal({show:true,keyboard:false,backdrop:'static'});
     ...
     function transactionRefund(trans_id)
    {
         $("#detailTitle").html(''); 
         $("#detailTitle").html('Initiate Refund');     
        $.ajax({
            url:base_phpurl+"/merchant/transactionRefundInit?transactionID="+trans_id,
            type:"GET",
            // dataType:"json",
            success:function(response){
                //console.log(response);
                $("#refund-transaction-model").modal({show:true,keyboard:false,backdrop:'static'});
                $('#transaction_refund_view').html(null);
                $('#transaction_refund_view').html(response.tran_details_view);
    ...
    function payouttransactionDetailsView(trans_id)
    {

        $.ajax({
            url:base_phpurl+"/merchant/payout_transaction_info?transferId="+trans_id,
            type:"GET",
            // dataType:"json",
            success:function(response){
               // console.log(response);
    ...
    function orderDetails(order_id)
    {
        ...
        $.ajax({
            url:base_phpurl+"/merchant/order/get/"+order_id,
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.length > 0)
    ...
    function editPaylink(paylinkid){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/paylink/edit/"+paylinkid,
            type:"GET",
            dataType:"json",
            success:function(response){
                if(response.length>0)
    ...
    {
       $.ajax({
        url:base_phpurl+"/merchant/item/edit/"+itemid,
        type:"GET",
        dataType:"json",
        success:function(response){
            if(response.length > 0)
    ...
    function editInvoice(invoiceid)
    {
        ...
        $.ajax({
            url:base_phpurl+"/merchant/invoice/edit/"+invoiceid,
            type:"GET",
            dataType:"json",
            success:function(response){
    ...
    function editCustomer(customerid)
    {
        ...
        {
            $.ajax({
                url:base_phpurl+"/merchant/customer/edit/"+customerid,
                type:"GET",
                dataType:"json",
                success:function(response){
                    if(response.length > 0)
    ...
    function generateApi(apiid)
    {
        ...
        {
            $.ajax({
                url:base_phpurl+"/merchant/api/edit/"+apiid,
                type:"GET",
                dataType:"json",
                success:function(response){
                    if(response.length > 0)
    ...
    //Edit Api javascript functionality code ends here
     //send activation request by  merchnat
     function sendActivationRequest(merchant_id,request_for)
    {
        //console.log('merchant_id='+merchant_id+',request_for='+request_for);

    }
   //send activation request by  merchnat end 
    ...
    function editProduct(id)
    {
        ...
        {
            $.ajax({
                url:base_phpurl+"/merchant/product/edit/"+id,
                type:"GET",
                dataType:"json",
                success:function(response){
                    if(response.length > 0)
    ...
    function showCustomerDetails(id){
        ...
        {
            $.ajax({
                url:base_phpurl+"/merchant/case-status/merchant/"+id,
                type:"GET",
                dataType:"json",
                success:function(response){
                    if(response.length > 0)
...
//Update data starts
    ...
    $("#paylink-edit").submit(function(event){
        ...
        if(paylinkid != "" && formvalidate)
        {
            ...
            $("div#divLoading").addClass('show');
            $.ajax({
                url:base_phpurl+"/merchant/paylink/update",
                type:"POST",
                data:getJsonObject(formdata),
                dataType:"json",
                success:function(response){
    ...
    $("#item-update-form").submit(function(event){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/item/update",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    function updateInvoice(value='')
    {
        ...
        if(isformvalid)
        {
            ...
            {
                $.ajax({
                    url:base_phpurl+"/merchant/invoice/update",
                    type:"POST",
                    data:formdata,
                    dataType:"json",
                    success:function(response){
                    ...
                    error:function(error){
                        ...
                        if(value == 'issued')
                        {
                            window.location.href=base_phpurl+'/merchant/invoices';
    ...
    $("#edit-customer-form").submit(function(e){
        ...
        {
            $.ajax({
                url:base_phpurl+"/merchant/customer/update",
                type:"POST",
                data:getJsonObject(formdata),
                dataType:"json",
                success:function(response){
    ...
    $("#add-edit-customer-address-form").submit(function(e){
        ...
        if(formvalidation){
            ...
            $.ajax({
                url:base_phpurl+"/merchant/customer-address/update",
                type:"POST",
                data:getJsonObject(formdata),
                dataType:"json",
                success:function(response){
    ...
    $("#update-product-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/product/update",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    {
        $.ajax({
            url:base_phpurl+"/merchant/notification/update/"+id,
            type:"GET",
            success:function(){},
            error:function(){},
            complete:function(){
    ...
    $("#edit-merchant-employee-form").submit(function(e){
        ...
        $.ajax({
            type:"POST",
            url:base_phpurl+"/merchant/employee/update",
            data:getJsonObject(formdata),
            dataType:"json",
            success: function (response) {
                if(response.status){
    ...
    //permission page
    function empPermission(employeegid){
        window.location.href=base_url+'/merchant/employee/type/'+employeegid;
    ...
    $("#merchant-employee-password-form").submit(function(e){
        ...
        $.ajax({
            type:"POST",
            url:base_phpurl+"/merchant/employee/reset-password",
            data:getJsonObject(formdata),
            dataType:"json",
            success: function (response) {
                if(response.status){
                    ...
                    $("#merchant-employee-password-form")[0].reset();
                setTimeout(() => {
                    $("#merchant-employee-password-modal").modal('hide');
                }, 3000);
                }else{
                    if(Object.keys(response.errors).length > 0){
                        $.each(response.errors,function(element,message){
    ...
    function updateEmpStatus(employeeid,status){
        ...
        $("#merchant-employee-status-form #id1").val(employeeid);
    ...
    $("#merchant-employee-status-form").submit(function(e){
        ...
        $.ajax({
            type:"POST",
            url:base_phpurl+"/merchant/employee/account-status",
            data:getJsonObject(formdata),
            dataType:"json",
            success: function (response) {
                if(response.status){
                ...
                setTimeout(() => {
                    ...
                    $("#merchant-employee-status-modal").modal('hide');
                }, 3000);
            }
        });
    });
    ...
    function unlockAccount(employeeid){
        $.ajax({
            type:"GET",
            url:base_phpurl+"/merchant/employee/unlock-account/"+employeeid,
            dataType:"json",
            success: function (response) {
                if(response.status){
...
$("#permissions-form-emp").submit(function(e) {
    ...
    $.ajax({
        url:base_url+"/merchant/employee/permissions",
        type:"POST",
        data: (formdata),
        dataType: "json",
        success: function(response) {
        window.scrollTo(0, 0);
        if (response.status) {
            $("#ajax-response-message").html(response.message).css({
                                 "color": "green"
             });
           $("#permissions-form-emp")[0].reset();
            ...
            if (typeof response.errors != "undefined" && Object.keys(response.errors).length > 0) {
                 $.each(response.errors, function(indexInArray, valueOfElement) {
                 $("#permissions-form-emp #" + indexInArray + "_ajax_error").html(valueOfElement[0]).css({
                                                        "color": "red"
            });
...
//Delete data starts
    ...
    $("#item-delete-form").submit(function(event){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/item/remove",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#delete-customer-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/customer/remove",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
     ...
     $("#customer-address-delete-form").submit(function(e){
         ...
         $.ajax({
            url:base_phpurl+"/merchant/customer-address/delete",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#product-delete-form").submit(function(e){
        ...
        $.ajax({
            url:base_phpurl+"/merchant/product/delete",
            type:"POST",
            data:getJsonObject(formdata),
            dataType:"json",
            success:function(response){
    ...
    $("#deactivate-pagedetail").submit(function(e){
        ...
        if(recordId!="")
        {
            $.ajax({
                type:"POST",
                url:base_phpurl+"/payment-pages/remove",
                data:getJsonObject(formdata),
                dataType:"json",
                success: function (response) {
                   if(response.status){
